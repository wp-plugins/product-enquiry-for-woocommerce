...
The Product Enquiry for WooCommerce plugin adds an enquiry button to every WooCommerce Product Page. Using this button a potential customer, can send you an enquiry about the product he is unsure of purchasing. By addressing his enquiries, you can convert an unsure customer, into a buyer! 

Also check out our premium version, <a href="http://wisdmlabs.com/woocommerce-product-enquiry-pro/">Product Enquiry PRO for WooCommerce</a>. It allows you to view enquiries right in your dashboard. You can even filter and export enquiries to help you analyse product demands.
...
* Email to Site Owner: An email is sent to pre-configured email address of the plugin user with details such as site name, product name, product URL, customer name and enquiry message in a well formatted manner.
...
* Contact Us: A plugin support sidebar in settings page provides you options to request a support query, make an enquiry for custom development, know additional services provided by us etc. right from the plugin settings page.
...
* Localization Ready: The PRO version is ready for translation. All you need to do is create the .mo and .po files for your language. Or you can contact us to help you.
...
<a href="http://wisdmlabs.com/woocommerce-product-enquiry-pro/">Get Product Enquiry PRO for WooCommerce</a>.
